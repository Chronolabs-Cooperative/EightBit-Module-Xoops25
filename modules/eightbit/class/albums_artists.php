 ...
 * @author              Simon Antony Roberts <wishcraft@users.sourceforge.net>
 */
class EightbitAlbums_artists extends XoopsObject
{
    /**
     *
     */
 ...
 */
class EightbitAlbums_artistsHandler extends XoopsPersistableObjectHandler
{
    /**
    ...
    {
        parent::__construct($db, '8bit_albums_artists', 'EightbitAlbums_artists', 'id', 'artistid');
    }
}
